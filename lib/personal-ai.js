...
// Use the broadly available production model as the safe default. Newer model
// names may be configured by an admin, but are attempted with this fallback so
// a retired/region-limited model cannot leave the public chat spinning forever.
