...
function providerError(provider, error) {
  ...
  if (/insufficient|no credits?|credit balance|credit_balance_exhausted|billing|payment required|spend limit|spend_limit_exceeded|usage_limit_exceeded|quota exceeded|insufficient_quota/.test(message)) {
