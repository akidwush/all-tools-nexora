...
const TOOL_CATALOG = Object.freeze([
  { id: "getcode", name: "Get Code HTML", category: "tools", target: { key: "internal-audit", type: "internal-api", path: "/api/audit", method: "OPTIONS", strict: true } },
  { id: "tiktok", name: "TikTok Downloader", category: "downloader", target: { key: "tikwm", type: "external-api", url: "https://www.tikwm.com/", method: "HEAD" } },
  { id: "ttquote", name: "TikTok Quote", category: "maker", target: { key: "module-tiktok-quote", type: "module", path: "/assets/js/features/tiktok-quote.js", method: "HEAD", strict: true } },
  ...
  { id: "sertifikat", name: "Sertifikat Generator", category: "maker", target: { key: "siputzx-api", type: "external-api", url: "https://api.siputzx.my.id/", method: "HEAD" } },
  { id: "fakedev", name: "Fake Developer", category: "maker", target: { key: "ikyyxd-api", type: "external-api", url: "https://api.ikyyxd.my.id/", method: "HEAD" } },
  ...
  { id: "fakeovo", name: "Fake OVO", category: "maker", target: { key: "module-imported", type: "module", path: "/assets/js/features/imported-tools.js", method: "HEAD", strict: true } },
  { id: "quotegenerator", name: "Quote Generator", category: "maker", target: { key: "module-imported", type: "module", path: "/assets/js/features/imported-tools.js", method: "HEAD", strict: true } },
  { id: "carifakta", name: "Cari Fakta", category: "tools", target: { key: "module-imported", type: "module", path: "/assets/js/features/imported-tools.js", method: "HEAD", strict: true } },
  ...
  { id: "winquotes", name: "Windows Quote", category: "maker", target: { key: "nexadev-api", type: "external-api", url: "https://apii.nexadev.my.id/", method: "HEAD" } },
  ...
  { id: "terabox", name: "Terabox Downloader", category: "downloader", target: { key: "nexray-api", type: "external-api", url: "https://api.nexray.eu.cc/", method: "HEAD" } },
  ...
  { id: "spotify", name: "Spotify Downloader", category: "downloader", target: { key: "nexray-api", type: "external-api", url: "https://api.nexray.eu.cc/", method: "HEAD" } },
  { id: "unbanwa", name: "Unban WhatsApp", category: "tools", target: { key: "module-unban", type: "module", path: "/assets/js/features/unban-whatsapp.js", method: "HEAD", strict: true } },
  { id: "zxvai", name: "Nexus AI", category: "tools", target: { key: "module-nexus-ai", type: "module", path: "/assets/js/features/nexus-ai.js", method: "HEAD", strict: true } },
  { id: "fotolink", name: "Pix Vault", category: "vault", target: { key: "module-pix-vault", type: "module", path: "/assets/js/features/pix-vault.js", method: "HEAD", strict: true } },
  { id: "vdeploy", name: "Vercel Deploy Center", category: "tools", target: { key: "module-deploy-center", type: "module", path: "/assets/js/features/deploy-center.js", method: "HEAD", strict: true } }
]);
...
async function fetchProbe(url, method, timeoutMs) {
  ...
  try {
    let response = await fetch(url, {
      ...
      headers: {
        Accept: "*/*",
        "User-Agent": "All-Tools-Nexora-Health/4.2",
