...
const TOOL_CATALOG = Object.freeze([
  ...
  { id: "instagram", name: "Instagram", category: "downloader", target: { key: "nexray-api", type: "external-api", url: "https://api.nexray.eu.cc/", method: "HEAD" } },
  ...
  { id: "youtube", name: "YouTube", category: "downloader", target: { key: "nexray-api", type: "external-api", url: "https://api.nexray.eu.cc/", method: "HEAD" } },
  ...
  { id: "sertifikat", name: "Sertifikat Tolol", category: "maker", target: { key: "siputzx-api", type: "external-api", url: "https://api.siputzx.my.id/", method: "HEAD" } },
  ...
  { id: "tiktokhd", name: "Upload TikTok HD", category: "external", target: { key: "core-shell", type: "restricted", path: "/assets/js/core/shell.js", method: "HEAD", strict: true } },
  { id: "getcode", name: "Get Code HTML", category: "external", target: { key: "internal-audit", type: "internal-api", path: "/api/audit", method: "OPTIONS", strict: true } },
  ...
  { id: "webencryption", name: "Web Encryption", category: "external", target: { key: "core-shell", type: "restricted", path: "/assets/js/core/shell.js", method: "HEAD", strict: true } },
...
async function fetchProbe(url, method, timeoutMs) {
  ...
  try {
    let response = await fetch(url, {
      ...
      headers: {
        Accept: "*/*",
        "User-Agent": "All-Tools-Nexora-Health/6.2",
