...
const TOOL_CATALOG = Object.freeze([
  { id: "aiodownloader", name: "All In One Downloader", category: "downloader", target: { key: "module-aio-downloader", type: "module", path: "/assets/js/features/aio-downloader.js", method: "HEAD", strict: true } },
  ...
  { id: "aiimage", name: "Nexora AI Image", category: "tools", target: { key: "module-puter-image", type: "module", path: "/assets/js/features/puter-image.js", method: "HEAD", strict: true } },
  { id: "aivideo", name: "Nexora AI Video Generator", category: "tools", target: { key: "module-puter-video", type: "module", path: "/assets/js/features/puter-video.js", method: "HEAD", strict: true } },
  { id: "genmail", name: "GenMail", category: "tools", target: { key: "module-genmail", type: "module", path: "/assets/js/features/genmail.js", method: "HEAD", strict: true } },
  { id: "danbooru", name: "Danbooru Search", category: "tools", target: { key: "module-danbooru-search", type: "module", path: "/assets/js/features/danbooru-search.js", method: "HEAD", strict: true } },
  { id: "animetoreal", name: "Anime to Real", category: "tools", target: { key: "module-anime-to-real", type: "module", path: "/assets/js/features/anime-to-real.js", method: "HEAD", strict: true } },
  { id: "aisong", name: "Nexora AI Song Generator", category: "tools", target: { key: "module-ai-song", type: "module", path: "/assets/js/features/ai-song.js", method: "HEAD", strict: true } },
  { id: "promptgenerate", name: "Nexora Prompt Generator", category: "tools", target: { key: "prompt-generator-api", type: "internal-api", path: "/api/prompt-generator", method: "HEAD", strict: true } },
  ...
  { id: "cryptomarket", name: "Crypto Market Scanner", category: "tools", target: { key: "crypto-market-api", type: "internal-api", path: "/api/crypto-market?currency=usd&limit=10", method: "HEAD", strict: true } },
  ...
  { id: "documentai", name: "Nexora Document AI", category: "tools", target: { key: "document-ai-api", type: "internal-api", path: "/api/document-ai", method: "GET", strict: true } },
  { id: "autopdf", name: "Nexora Auto PDF", category: "tools", target: { key: "text-to-pdf-api", type: "internal-api", path: "/api/tools/text-to-pdf", method: "GET", strict: true } },
  ...
  { id: "alightpremium", name: "Alight Motion Premium 1 Tahun", category: "tools", target: { key: "alight-premium-api", type: "internal-api", path: "/api/alight-premium", method: "HEAD", strict: true } },
  ...
  { id: "text2d", name: "2D Text Animate / Text FX", category: "tools", target: { key: "module-nexora-runtime", type: "module", path: "/assets/js/features/nexora/nexora-runtime.js", method: "HEAD", strict: true } },
  { id: "text3d", name: "3D Text Animate", category: "tools", target: { key: "module-nexora-3d", type: "module", path: "/assets/vendor/nexora/3d-engine.js", method: "HEAD", strict: true } },
  { id: "textfxanimation", name: "Text FX Animation", category: "tools", target: { key: "module-nexora-fx", type: "module", path: "/assets/vendor/nexora/text-fx-animation-engine.js", method: "HEAD", strict: true } },
  { id: "textvector", name: "Text to Vector", category: "tools", target: { key: "module-nexora-vector", type: "module", path: "/assets/js/workers/nexora-vector-worker.js", method: "HEAD", strict: true } },
  { id: "trimpath", name: "Trimpath Generator", category: "tools", target: { key: "module-nexora-trimpath", type: "module", path: "/assets/vendor/nexora/trimpath-engine.js", method: "HEAD", strict: true } },
  { id: "logoanimate", name: "Logo Animate", category: "tools", target: { key: "module-nexora-logo", type: "module", path: "/assets/js/features/nexora/logo-engine.js", method: "HEAD", strict: true } },
  ...
  { id: "enhancer", name: "Nexora Image HD Enhancer V4", category: "tools", target: { key: "module-hd4-enhancer", type: "module", path: "/assets/js/features/hd4-enhancer.js", method: "HEAD", strict: true } },
  { id: "ttquote", name: "Quote TikTok Nexora", category: "vault", target: { key: "module-tiktok-quote", type: "module", path: "/assets/js/features/tiktok-quote.js", method: "HEAD", strict: true } },
