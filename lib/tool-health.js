...
const TOOL_CATALOG = Object.freeze([
  ...
  { id: "promptgenerate", name: "Prompt Generator", category: "tools", target: { key: "prompt-generator-api", type: "internal-api", path: "/api/prompt-generator", method: "HEAD", strict: true } },
  ...
  { id: "text2d", name: "2D Text Animate / Text FX", category: "tools", target: { key: "module-flamo-runtime", type: "module", path: "/assets/js/features/flamo/flamo-runtime.js", method: "HEAD", strict: true } },
  { id: "text3d", name: "3D Text Animate", category: "tools", target: { key: "module-flamo-3d", type: "module", path: "/assets/vendor/flamo/3d-engine.js", method: "HEAD", strict: true } },
  { id: "textfxanimation", name: "Text FX Animation", category: "tools", target: { key: "module-flamo-fx", type: "module", path: "/assets/vendor/flamo/text-fx-animation-engine.js", method: "HEAD", strict: true } },
  { id: "textvector", name: "Text to Vector", category: "tools", target: { key: "module-flamo-vector", type: "module", path: "/assets/js/workers/flamo-vector-worker.js", method: "HEAD", strict: true } },
  { id: "trimpath", name: "Trimpath Generator", category: "tools", target: { key: "module-flamo-trimpath", type: "module", path: "/assets/vendor/flamo/trimpath-engine.js", method: "HEAD", strict: true } },
  { id: "logoanimate", name: "Logo Animate", category: "tools", target: { key: "module-flamo-logo", type: "module", path: "/assets/js/features/flamo/logo-engine.js", method: "HEAD", strict: true } },
