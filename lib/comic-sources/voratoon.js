...
async function listPage({ page = 1, limit = 24, query = "", fetchImpl, timeoutMs, signal }) {
  ...
  const payload = await requestJson({ base: definition.apiBase, path: "./", params, headers: headers(), provider: definition.label, fetchImpl, timeoutMs, signal, cacheMs: 120_000 });
