...
const endpointDefinition = Object.freeze({
  id: "comic:mangadex", group: "comic", label: "MangaDex", category: "comic",
  allowedHosts: ["api.mangadex.org"], defaultBaseUrl: definition.apiBase,
  defaultTimeoutMs: 14_000, minTimeoutMs: 1_000, maxTimeoutMs: 60_000,
  healthPath: "/manga?limit=1&contentRating[]=safe", healthMethod: "GET",
...
module.exports = { createMangaDexAdapter, definition, endpointDefinition };
