(function(){
  ...
  function restore(){try{var cached=JSON.parse(localStorage.getItem("nexora-admin-functional-audit-v62")||"null");if(cached&&cached.version==="6.3.18"&&Array.isArray(cached.results)){state.result=cached;render();}}catch(_){ }}
