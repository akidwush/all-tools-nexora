(function(){
  ...
  async function run(){
    ...
    try{
      ...
      try{localStorage.setItem("nexora-admin-functional-audit-v62",JSON.stringify(state.result));}catch(_){ }
  ...
  function restore(){try{var cached=JSON.parse(localStorage.getItem("nexora-admin-functional-audit-v62")||"null");if(cached&&cached.version==="6.3.17"&&Array.isArray(cached.results)){state.result=cached;render();}}catch(_){ }}
