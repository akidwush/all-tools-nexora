(function () {
  ...
  function html() {
    ...
    return '<section class="nc-shell nc-director-shell">' +
      ...
      '<label class="wide" data-nc="puter-model-field">Artwork Model<select data-nc="puter-model"><option value="gpt-image-2" selected>Auto — GPT Image 2 + fallback</option><option value="gpt-image-1-mini">GPT Image Mini — hemat</option><option value="google/imagen-4.0-fast">Imagen 4 Fast</option><option value="' + flashModel + '">Nexora Flash Image</option><option value="qwen/qwen-image-2.0-pro">Qwen Image 2 Pro</option><option value="black-forest-labs/flux-schnell">FLUX Schnell</option></select></label>' +
      ...
      '<div class="nc-cost" data-nc="cost">Mode gratis: <b>1 hasil artwork</b>. Model cadangan hanya dicoba jika model utama sibuk atau tidak tersedia.</div>' +
