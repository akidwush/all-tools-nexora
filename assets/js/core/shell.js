...
(function(){
  ...
  var roomTools = {
    ...
    novelcover:{renderer:'renderNovelCoverGenerator', category:'tools', icon:'fa-solid fa-book-atlas', title:'Nexora Novel Cover Generator', desc:'Buat cover novel melalui allowance Puter gratis atau provider Pro, lalu susun title dan author di Nexora Composer.', accent:'#a78bfa', accent2:'#67e8f9', rgb:'167,139,250', badge:'Free-First Cover AI'},
