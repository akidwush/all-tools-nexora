...
virusscan:  {renderer:'renderVirusScan', category:'tools', icon:'fa-solid fa-shield-virus', title:'Virus Scan Nexora', desc:'Analisis lokal untuk URL, file, hash, domain, dan IP dalam ruang keamanan All Tools Nexora.', accent:'#c084fc', accent2:'#7c3aed', rgb:'192,132,252', badge:'Nexora Security Core'},
    ...
    text2d:{renderer:'renderFlamoText2D',category:'tools',icon:'fa-solid fa-font',title:'2D Text Animate / Text FX',desc:'Generator XML teks 2D dengan preset, keyframe, cubic Bézier, Style FX, color mapping, dan timing lokal.',accent:'#a78bfa',accent2:'#22d3ee',rgb:'167,139,250',badge:'Flamo Engine · Native Nexora'},
