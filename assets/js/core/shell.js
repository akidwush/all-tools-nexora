...
/* ===== Nexora v6.3.12: unlocked external tools ===== */
(function(){
  "use strict";
...
instagram:  {renderer:'renderInstagram',   category:'downloader', icon:'fa-brands fa-instagram', title:'Instagram Downloader', desc:'Ambil video, Reels, foto, carousel, metadata, dan caption dalam ruang download khusus.', accent:'#e879f9', accent2:'#c026d3', rgb:'232,121,249', badge:'Media Studio'},
    ...
    sertifikat: {renderer:'renderSertifikatTololSource', category:'maker', icon:'fa-solid fa-certificate', title:'Sertifikat Tolol', desc:'Generator sumber Nexus yang memakai endpoint asli Siputzx sehingga hasil gambar tetap sama dengan HTML sumber.', accent:'#facc15', accent2:'#a855f7', rgb:'250,204,21', badge:'Nexus Source API'},
