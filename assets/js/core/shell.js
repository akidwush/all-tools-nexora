...
(function(){
  ...
  var roomTools = {
    ...
    novelcover:{renderer:'renderNovelCoverGenerator', category:'tools', icon:'fa-solid fa-book-atlas', title:'Nexora Novel Cover Generator', desc:'Buat artwork cover novel melalui provider AI yang tersedia, bandingkan hasil, lalu susun title dan author di Nexora Composer.', accent:'#a78bfa', accent2:'#67e8f9', rgb:'167,139,250', badge:'Multi-Provider Cover AI'},
