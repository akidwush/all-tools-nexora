...
(function(){
  ...
  var roomTools = {
    ...
    multiai:{renderer:'renderMultiAi', category:'tools', icon:'fa-solid fa-diagram-project', title:'Nexora Multi-AI', desc:'Kirim satu prompt ke banyak AI dan gunakan Image AI, Audio AI, serta AI Tools dalam satu hub aman.', accent:'#9f7aea', accent2:'#22d3ee', rgb:'159,122,234', badge:'27 KuroNeko AI'},
    ...
    elevenlabs:{renderer:'renderElevenLabsStudio', category:'tools', icon:'fa-solid fa-wave-square', title:'Nexora ElevenLabs Studio', desc:'Text to Speech, Voice Changer, Speech to Text, dan Sound FX melalui proxy audio AI aman Nexora.', accent:'#9b6cff', accent2:'#73e7ee', rgb:'155,108,255', badge:'Nexora Audio AI'},
    ...
    novelcover:{renderer:'renderNovelCoverGenerator', category:'tools', icon:'fa-solid fa-book-atlas', title:'Nexora Novel Cover Generator', desc:'AI Cover Director mengatur artwork, hierarchy, palet, ruang judul, dan typography novel secara otomatis.', accent:'#a78bfa', accent2:'#67e8f9', rgb:'167,139,250', badge:'AI Cover Director'},
...
virusscan:  {renderer:'renderVirusScan', category:'tools', icon:'fa-solid fa-shield-virus', title:'Virus Scan Nexora', desc:'Analisis lokal untuk URL, file, hash, domain, dan IP dalam ruang keamanan All Tools Nexora.', accent:'#c084fc', accent2:'#7c3aed', rgb:'192,132,252', badge:'Nexora Security Core'},
    ...
    smartcutout:{renderer:'renderNexoraSmartCutout', category:'tools', icon:'fa-solid fa-object-ungroup', title:'Nexora Smart Cutout', desc:'Tap objek, refine mask dengan titik Select atau Remove, lalu ekspor PNG transparan. Semua piksel tetap diproses lokal di browser.', accent:'#a855f7', accent2:'#7c3aed', rgb:'168,85,247', badge:'MagicTouch · Local AI'},
    placeholderstudio:{renderer:'renderNexoraPlaceholderStudio', category:'tools', icon:'fa-regular fa-image', title:'Nexora Placeholder Studio', desc:'Buat placeholder Classic dari ukuran, warna, dan teks atau gunakan prompt untuk placeholder bergaya. Tidak memerlukan API key.', accent:'#a855f7', accent2:'#22d3ee', rgb:'168,85,247', badge:'Classic · Prompt · No API Key'},
