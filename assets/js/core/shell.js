...
virusscan:  {renderer:'renderVirusScan', category:'tools', icon:'fa-solid fa-shield-virus', title:'Virus Scan Nexora', desc:'Analisis lokal untuk URL, file, hash, domain, dan IP dalam ruang keamanan All Tools Nexora.', accent:'#c084fc', accent2:'#7c3aed', rgb:'192,132,252', badge:'Nexora Security Core'},
    ...
    svgalight:{renderer:'renderSvgAlight', category:'tools', icon:'fa-solid fa-wand-magic-sparkles', title:'SVG → Alight XML', desc:'Konversi SVG menjadi XML Alight Motion dengan Lossless, Accurate, Balanced, dan Lightweight melalui Anime Vector Atelier.', accent:'#67e8f9', accent2:'#f0abfc', rgb:'103,232,249', badge:'Anime Vector Atelier'},
    ...
    bigimage:{renderer:'renderBigImage', category:'tools', icon:'fa-solid fa-up-right-and-down-left-from-center', title:'Big Image', desc:'Upscale ilustrasi dan foto 2×–16× melalui Bigjpg AI dengan reduksi noise, upload privat sementara, serta pembanding sebelum dan sesudah.', accent:'#38bdf8', accent2:'#8b5cf6', rgb:'56,189,248', badge:'Bigjpg AI Upscaler'},
instagram:  {renderer:'renderInstagram',   category:'downloader', icon:'fa-brands fa-instagram', title:'Instagram Downloader', desc:'Ambil video, Reels, foto, carousel, metadata, dan caption dalam ruang download khusus.', accent:'#e879f9', accent2:'#c026d3', rgb:'232,121,249', badge:'Media Studio'},
    ...
    spotify:    {renderer:'renderSpotify',     category:'downloader', icon:'fa-brands fa-spotify', title:'Spotify Metadata', desc:'Lihat metadata publik dan lanjutkan melalui tautan resmi Spotify. Ekstraksi MP3 tidak disediakan.', accent:'#4ade80', accent2:'#16a34a', rgb:'74,222,128', badge:'Official Link'},
