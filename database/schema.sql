...
create table if not exists public.ai_settings (
  ...
  model text not null default 'gemini-2.5-flash' check (model in ('gemini-3.6-flash','gemini-3.5-flash','gemini-3.5-flash-lite','gemini-3.1-flash-lite','gemini-2.5-flash')),
