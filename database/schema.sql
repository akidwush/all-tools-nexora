...
values
  ...
  ('promptgenerate', 'Prompt Generator', 'Ubah gambar menjadi prompt deskriptif', 'tools', 'LOCAL', 'fa-solid fa-wand-magic-sparkles', null, true, 20, '{}'::jsonb),
  ...
  ('alightpremium', 'Alight Motion Premium 1 Tahun', 'Request magic link lalu proses aktivasi Premium melalui API reseller', 'tools', '1 YEAR', 'fa-solid fa-bolt', null, true, 69, '{"provider":"kyzznekoo","serverProxy":true,"userKeySupported":true,"features":["magic-link","apply-premium"]}'::jsonb),
