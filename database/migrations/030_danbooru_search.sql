-- Nexora HF32 — Danbooru Search melalui proxy KuroNeko server-side.
...
values
  (
    'danbooru',
    'Danbooru Search',
    'Cari ilustrasi anime berdasarkan tag dalam gallery ringan',
    'tools',
    'SAFE DEFAULT',
    'fa-solid fa-images',
    null,
    true,
    19,
    '{"provider":"kuroneko","serverProxy":true,"apiKeyRequired":true,"defaultMode":"safe","galleryColumns":2}'::jsonb,
    'free'
  )
