...
(async()=>{
 ...
 assert.match(read('assets/comic-reader/app.js'),/nexora:comic-pages/);assert.match(read('assets/comic-reader/app.js'),/translationCompatible/);assert.match(read('assets/comic-reader/index.html'),/translate-queue\.js/);
 assert.match(read('assets/comic-reader/translate.js'),/translationCompatible/);assert.match(read('assets/comic-reader/translate.js'),/Translate All belum kompatibel/);
