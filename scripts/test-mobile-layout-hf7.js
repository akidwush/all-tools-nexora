...
assert.ok(read("admin/login.html").includes("assets/css/admin.css?v=6.3.17"));
assert.ok(read("admin/index.html").includes("assets/css/admin.css?v=6.3.17"));
...
assert.ok(index.includes("assets/css/components.css?v=6.3.17"));
assert.match(loader, /ASSET_VERSION = '6\.3\.17'/);
