...
const accessPolicy = require("../lib/server-access-policy");
...
assert.equal(accessPolicy.toolHealthToolId("", { body: {} }, new URL("https://nexora.test/api/tool-health?_service=anime-to-real")), "animetoreal");
