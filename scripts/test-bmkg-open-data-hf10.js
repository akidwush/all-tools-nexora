...
assert.equal(getTool("bmkg").name, "BMKG Indonesia");
assert.equal(getTool("bmkg").runtime.module, "bmkg-open-data");
assert.equal(getTool("bmkg").runtime.handler, "renderBmkgIndonesia");
...
assert.equal(getTool("bmkg").health.path, "/api/bmkg?health=1");
