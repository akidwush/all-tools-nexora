...
const required = [
  ...
  "lib/database.js", "lib/audit.js", "lib/tool-health.js", "database/schema.sql", "database/migrations/002_tool_health.sql"
];
...
const generated = ["public/index.html", "public/assets/js/core/lazy-loader.js", "public/assets/js/core/tool-health.js", "public/assets/module-manifest.json"];
...
console.log("Feature payload besar dimuat saat tool dibuka; live audit dan tool health monitoring tersedia di API serverless.");
