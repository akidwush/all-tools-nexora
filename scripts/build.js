...
const required = [
  ...
  "database/schema.sql", "database/migrations/002_tool_health.sql", "database/migrations/003_admin_dashboard.sql", "database/migrations/004_analytics_feedback_audit.sql", "database/migrations/005_visual_runtime_validation.sql", "database/migrations/006_social_links.sql", "database/migrations/009_nexora_web_intelligence.sql", "database/migrations/010_nasa_space_explorer.sql", "database/migrations/011_nexora_ocr_intelligence.sql", "database/migrations/012_nexora_image_vectorizer.sql", "database/setup-first-admin.sql", "scripts/test-mobile-layout-hf7.js", "scripts/test-ocr-intelligence-hf8.js", "scripts/test-image-vectorizer-hf9.js", "V6_1_VALIDATION.md", "V6_1_1_VALIDATION.md", "V6_2_VALIDATION.md", "V6_3_VALIDATION.md", "V6_3_1_VALIDATION.md", "V6_3_2_VALIDATION.md", "V6_3_11_VALIDATION.md", "V6_3_13_VALIDATION.md"
];
