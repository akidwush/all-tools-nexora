...
const required = [
  ...
  "assets/js/core/app.js", "assets/js/core/shell.js", "assets/js/core/social-links.js", "assets/js/core/tool-health.js", "assets/js/core/lazy-loader.js",
  ...
  "database/schema.sql", "database/migrations/002_tool_health.sql", "database/migrations/003_admin_dashboard.sql", "database/migrations/004_analytics_feedback_audit.sql", "database/migrations/005_visual_runtime_validation.sql", "database/migrations/006_social_links.sql", "database/setup-first-admin.sql", "V6_1_VALIDATION.md"
];
...
const generated = [
  ...
  "public/assets/js/admin/dashboard.js", "public/assets/js/admin/visual-qa.js", "public/assets/css/visual-qa.css", "public/assets/js/core/runtime-observer.js", "public/assets/js/core/lazy-loader.js", "public/assets/js/core/social-links.js", "public/assets/js/core/tool-health.js", "public/assets/js/core/analytics.js", "public/assets/module-manifest.json"
];
...
console.log("Feature payload besar dimuat saat tool dibuka; social link control, Runtime JS test, screenshot, visual baseline, analytics, feedback, audit log, login, dan dashboard admin v6.1 tersedia di /admin.");
