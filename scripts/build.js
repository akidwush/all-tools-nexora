...
const required = [
  ...
  "database/schema.sql", "database/migrations/002_tool_health.sql", "database/migrations/003_admin_dashboard.sql", "database/setup-first-admin.sql"
];
...
const generated = [
  ...
  "public/assets/js/admin/dashboard.js", "public/assets/js/core/lazy-loader.js", "public/assets/js/core/tool-health.js", "public/assets/js/core/analytics.js", "public/assets/module-manifest.json"
];
...
console.log("Feature payload besar dimuat saat tool dibuka; analytics, feedback management, audit log, login, dan dashboard admin v5.1 tersedia di /admin.");
