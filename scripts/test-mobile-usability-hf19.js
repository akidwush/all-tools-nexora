...
assert.match(html, /mobile-usability\.css\?v=6\.3\.18-hf19-readable1/);
...
assert.doesNotMatch(css, /\.tools-grid|\.tools-card/);
...
console.log("HF19 mobile usability lulus: workspace fitur lebih lebar, teks terbaca, kontrol sentuh besar, dan grid katalog tetap utuh.");
