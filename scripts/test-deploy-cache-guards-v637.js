...
assert.ok(loader.includes("var ASSET_VERSION = '6.3.13-hf11-vtracer-local-20260812'"));
...
assert.ok(index.includes('assets/css/core.css?v=6.3.13-hf11-vtracer-local-20260812'));
assert.ok(index.includes('assets/js/core/lazy-loader.js?v=6.3.13-hf11-vtracer-local-20260812'));

const admin = read('admin/index.html');
assert.ok(admin.includes('id="addToolButton" data-add-tool="true"'));
assert.ok(admin.includes('../assets/js/admin/dashboard.js?v=6.3.13'));
...
console.log('Nexora v6.3.13 tests lulus: cache-busted lazy assets, always-on TikTok media containment, and resilient Add Tool binding.');
