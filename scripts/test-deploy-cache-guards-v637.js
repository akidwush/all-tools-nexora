...
assert.ok(index.includes('assets/css/core.css?v=6.3.11'));
assert.ok(index.includes('assets/js/core/lazy-loader.js?v=6.3.11'));

const admin = read('admin/index.html');
assert.ok(admin.includes('id="addToolButton" data-add-tool="true"'));
assert.ok(admin.includes('../assets/js/admin/dashboard.js?v=6.3.11'));
...
console.log('Nexora v6.3.11 tests lulus: cache-busted lazy assets, always-on TikTok media containment, and resilient Add Tool binding.');
