...
assert.match(loader, /ASSET_VERSION\s*=\s*['"]6\.3\.18['"]/);
...
assert.ok(index.includes('assets/css/core.css?v=6.3.18'));
...
assert.ok(admin.includes('../assets/js/admin/dashboard.js?v=6.3.18'));
...
console.log('Nexora v6.3.18 tests lulus: cache-busted lazy assets, always-on TikTok media containment, and resilient Add Tool binding.');
