...
assert.ok(index.includes('assets/css/core.css?v=6.4.0'));
...
assert.ok(admin.includes('../assets/js/admin/dashboard.js?v=6.4.0'));
...
console.log('Nexora v6.4.0 tests lulus: cache-busted lazy assets, always-on TikTok media containment, and resilient Add Tool binding.');
