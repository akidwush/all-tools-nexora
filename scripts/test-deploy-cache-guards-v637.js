...
assert.match(loader, /ASSET_VERSION\s*=\s*['"]6\.3\.16['"]/);
...
assert.ok(index.includes('assets/css/core.css?v=6.3.16'));
assert.ok(index.includes('assets/js/core/lazy-loader.js?v=6.3.16'));

const admin = read('admin/index.html');
assert.ok(admin.includes('id="addToolButton" data-add-tool="true"'));
assert.ok(admin.includes('../assets/js/admin/dashboard.js?v=6.3.16'));
...
console.log('Nexora v6.3.16 tests lulus: cache-busted lazy assets, always-on TikTok media containment, and resilient Add Tool binding.');
