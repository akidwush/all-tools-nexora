...
assert.match(loader, /ASSET_VERSION\s*=\s*['"]6\.3\.13-hf4['"]/);
...
assert.ok(index.includes('assets/css/core.css?v=6.3.13-hf4'));
assert.ok(index.includes('assets/js/core/lazy-loader.js?v=6.3.13-hf4'));
