...
for (const token of ["NexoraToolRegistry",'version:"6.3.7"',"count:rows.length"]) if(!registryV62.includes(token)) fail(`Tool registry v6.2 belum lengkap: ${token}`);
