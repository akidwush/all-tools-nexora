...
if (!/COMIC_APP_URL\s*=\s*["']\/assets\/comic-reader\/index\.html\?v=standalone-v1-readerui2-experimental1["']/.test(comicShell)) fail("Comic Reader tidak memakai app standalone canonical.");
