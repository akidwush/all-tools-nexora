...
for(const token of ["renderImageVectorizer","VTRACER_SOURCES","ColorImageConverter","BinaryImageConverter","new_with_string","converter.tick()","quantizeCanvas","binarizeCanvas","optimizeSvgText","fidelityScore","Adaptive HQ","NO DAILY LIMIT","Download SVG","Copy SVG code","fit 100%"]){
