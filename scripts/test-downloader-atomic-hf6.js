...
async function main() {
  ...
  assert.match(renderers, /window\.renderSpotify=renderSpotify/);
  assert.doesNotMatch(app, /function renderSpotify\(/, "Spotify hanya memiliki satu renderer canonical");
