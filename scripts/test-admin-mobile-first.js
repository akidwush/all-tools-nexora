...
assert(Object.keys(iconMap).length === 63, "Seluruh 63 tool bawaan harus memiliki ikon admin.");
...
console.log("Admin mobile-first lulus: stats 2 kolom, bottom nav, filter ringkas, kartu compact, 63 ikon unik, dan safe-area tervalidasi.");
