...
assert(Object.keys(iconMap).length === 65, "Seluruh 65 tool bawaan harus memiliki ikon admin.");
...
console.log("Admin mobile-first lulus: stats 2 kolom, bottom nav, filter ringkas, kartu compact, 65 ikon unik, dan safe-area tervalidasi.");
