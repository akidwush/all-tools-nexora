...
assert(Object.keys(iconMap).length === 64, "Seluruh 64 tool bawaan harus memiliki ikon admin.");
...
console.log("Admin mobile-first lulus: stats 2 kolom, bottom nav, filter ringkas, kartu compact, 64 ikon unik, dan safe-area tervalidasi.");
