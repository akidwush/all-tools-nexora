...
assert(Object.keys(iconMap).length === 62, "Seluruh 62 tool bawaan harus memiliki ikon admin.");
...
console.log("Admin mobile-first lulus: stats 2 kolom, bottom nav, filter ringkas, kartu compact, 62 ikon unik, dan safe-area tervalidasi.");
