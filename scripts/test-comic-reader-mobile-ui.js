...
assert.match(html, /app\.css\?v=standalone-v1-polish2/);
assert.match(html, /app\.js\?v=standalone-v1[^"']*polish2/);
...
assert.match(app, /reader-source-button/);
...
assert.match(css, /\.reader-topbar\{[\s\S]*height:var\(--toolbar-height\)/);
