...
assert.match(shell, /COMIC_APP_URL\s*=\s*['"]\/assets\/comic-reader\/index\.html\?v=standalone-v1-readerui2-experimental2['"]/);
...
assert.match(html, /app\.css\?v=standalone-v1-readerback1-experimental2/);
assert.match(html, /app\.js\?v=standalone-v1[^"']*readerback1-experimental2/);
