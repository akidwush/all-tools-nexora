...
assert.match(html, /liquid-reactor\.js\?v=6\.3\.18-hf11\.1-static-mobile-tabs/);
...
console.log('Liquid Reactor Step 2 tests lulus: aperture, mercury nav, FLIP grid, tilt terdelegasi, dan droplet room terpasang.');
